        ...
        <div class="max-w-md w-full bg-zinc-900/80 border border-red-900/30 p-8 rounded-xl shadow-2xl backdrop-blur-md">
            ...
            <form id="registerForm" class="space-y-6">
                <div>
                    ...
                    <input type="text" id="name" name="name" required class="mt-1 block w-full px-3 py-2 bg-black border border-red-900/30 rounded-md text-white focus:outline-none focus:border-red-500 focus:ring-1 focus:ring-red-500 transition-colors">
                </div>
                <div>
            ...
            <div class="mt-4 text-center">
                <p class="text-sm text-gray-400">Já tem uma conta? <a href="/login.php" class="text-red-500 hover:text-red-400">Faça login</a></p>
            </div>
