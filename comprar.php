...
<head>
    ...
    <style>
        ...
        .glow {
            box-shadow: 0 0 0 1px rgba(220, 38, 38, 0.15), 0 18px 55px rgba(220, 38, 38, 0.10);
        }
...
<body class="bg-black text-white font-sans antialiased relative">
    ...
    <div id="root">
        <div
            class="min-h-screen flex flex-col bg-black text-white selection:bg-ff-red selection:text-white overflow-x-hidden">
            <!-- Navbar -->
            <nav
                ...
                <div class="max-w-[1600px] mx-auto px-4 sm:px-6 lg:px-8 relative">
                    ...
                    <div id="nav-mobile" class="xl:hidden hidden pb-4">
                        <div
                            class="mt-2 rounded-2xl border border-white/10 bg-black/60 backdrop-blur-md overflow-hidden">
                ...
                <div class="max-w-6xl mx-auto w-full">
                    <div class="reveal" data-reveal>
                        ...
                        <div class="mt-4 flex flex-col sm:flex-row sm:items-end sm:justify-between gap-4">
                            ...
                            <div class="flex items-center gap-2">
                                ...
                                <?php endif; ?>
                                <div class="px-4 py-2 rounded-2xl glass">
                                    <div class="text-[10px] uppercase tracking-[0.22em] text-white/50 font-black">planos
                                    </div>
                    ...
                    <div class="mt-8 grid grid-cols-1 xl:grid-cols-3 gap-6">
                        <div class="xl:col-span-2 rounded-3xl glass glow overflow-hidden relative reveal" data-reveal>
                            <div
                                class="absolute -top-16 -right-16 w-80 h-80 bg-ff-red/10 rounded-full blur-[120px] pointer-events-none">
                            </div>
                            <div
                                class="absolute -bottom-20 -left-20 w-80 h-80 bg-white/5 rounded-full blur-[120px] pointer-events-none">
                            </div>
                                ...
                                <div class="grid grid-cols-1 lg:grid-cols-5 gap-6 items-start">
                                    ...
                                    <div class="lg:col-span-3">
                                        <div class="flex flex-wrap items-center gap-2">
                                            <span
                                                class="px-3 py-1 rounded-full text-xs font-black tracking-wide bg-ff-red/10 border border-ff-red/30 text-red-200">Premium</span>
                                            <span
                                                class="px-3 py-1 rounded-full text-xs font-black tracking-wide bg-white/5 border border-white/10 text-white/70">Suporte</span>
                                            <span
                                                class="px-3 py-1 rounded-full text-xs font-black tracking-wide bg-white/5 border border-white/10 text-white/70">Atualizações</span>
                                        </div>
                                        ...
                                        <?php if (count($featuresTop) > 0): ?>
                                            <div class="mt-6">
                                                <div
                                                    class="text-xs font-black uppercase tracking-[0.22em] text-white/50 mb-3">
                                                    Recursos</div>
                                        ...
                                        <div class="mt-7 grid grid-cols-1 sm:grid-cols-3 gap-3">
                                            <div class="rounded-2xl border border-white/10 bg-black/30 p-4">
                                                <div
                                                    class="text-xs text-white/60 font-black uppercase tracking-[0.22em]">
                                                    Segurança</div>
                        ...
                        <div class="rounded-3xl glass glow p-6 md:p-7 reveal" data-reveal>
                            <div class="flex items-end justify-between gap-4">
                                ...
                                <?php if ($bestPlanId): ?>
                                    <div
                                        class="px-3 py-1 rounded-full text-xs font-black bg-ff-red/10 border border-ff-red/30 text-red-200">
                                        Recomendado</div>
                                <?php endif; ?>
                            </div>
                            ...
                            <form id="addToCartForm" method="POST" class="mt-5">
                                ...
                                <div class="grid grid-cols-1 gap-3">
                                    <?php foreach ($plans as $idx => $plan): ?>
                                        ...
                                        <label class="block cursor-pointer group h-full">
                                            <input type="radio" name="plan_id" value="<?php echo $pid; ?>"
                                                data-name="<?php echo htmlspecialchars((string) $plan['name']); ?>"
                                                data-price="<?php echo htmlspecialchars((string) $plan['price']); ?>"
                                                class="peer sr-only" <?php echo $checked ? 'checked' : ''; ?>>
                                            <div
                                                class="rounded-2xl border border-white/10 bg-black/30 px-4 py-4 transition-all duration-300 group-hover:border-white/20 peer-checked:border-ff-red/60 peer-checked:bg-ff-red/10">
                                                <div class="flex items-center justify-between gap-3">
                                                    <div class="min-w-0">
                                                        <div class="flex items-center gap-2 min-w-0">
                                                            <div class="text-base font-black leading-tight break-words">
                                                                <?php echo htmlspecialchars((string) $plan['name']); ?>
                                                            </div>
                                                            <?php if ($isBest): ?>
                                                                <span
                                                                    class="shrink-0 px-2 py-0.5 rounded-full text-[10px] font-black uppercase tracking-[0.22em] bg-ff-red/10 border border-ff-red/30 text-red-200">
                                                                    Recomendado
                                                                </span>
                                                            <?php endif; ?>
                                                        </div>
                                                        <div class="mt-1 text-xs text-white/55 font-semibold">
                                                            Clique para selecionar
                                                        </div>
                                                    </div>
                                                    <div class="shrink-0 text-right">
                                                        <div
                                                            class="text-[10px] font-black uppercase tracking-[0.22em] text-white/45">
                                                            Total</div>
                                ...
                                <div class="mt-5 rounded-2xl border border-white/10 bg-black/30 p-4">
                                    <div class="flex items-center justify-between gap-3">
                                        <div>
                                            <div
                                                class="text-[10px] font-black uppercase tracking-[0.22em] text-white/50">
                                                Selecionado</div>
                                ...
                                <button type="submit"
                                    class="mt-5 w-full bg-ff-red text-white font-black uppercase py-4 rounded-2xl hover:bg-red-700 transition-colors tracking-wider shadow-[0_10px_30px_rgba(255,0,0,0.22)] hover:shadow-[0_14px_40px_rgba(255,0,0,0.32)] flex items-center justify-center gap-2">
                                ...
                                <a href="/teste-gratis.php?game=<?php echo htmlspecialchars($slug); ?>"
                                    class="mt-3 w-full inline-flex items-center justify-center rounded-2xl border border-white/10 bg-white/5 hover:bg-white/10 transition font-black py-4">
                                    Conseguir uma key grátis (2h) para testar
                                </a>
                            </form>
                        </div>
                    </div>
                    ...
                    <div class="mt-8 grid grid-cols-1 lg:grid-cols-3 gap-6">
                        <div class="rounded-3xl glass p-6 reveal" data-reveal>
                            ...
                            <div class="text-white/60 text-sm mt-2">Após o pagamento, o acesso é liberado rapidamente.
                            </div>
                        </div>
                        <div class="rounded-3xl glass p-6 reveal" data-reveal>
                            <div class="text-sm font-black uppercase tracking-wide">Suporte</div>
                            <div class="text-white/60 text-sm mt-2">Atendimento via Discord e suporte assistido quando
                                necessário.</div>
                        </div>
                        <div class="rounded-3xl glass p-6 reveal" data-reveal>
                            <div class="text-sm font-black uppercase tracking-wide">Atualizações</div>
                            <div class="text-white/60 text-sm mt-2">Atualizações e manutenção para manter o produto
                                estável.</div>
                        </div>
                    </div>
                    ...
                    <div class="mt-10 rounded-3xl glass p-6 md:p-8 reveal" data-reveal>
                        ...
                        <div class="mt-5 space-y-3">
                            <button
                                class="w-full text-left rounded-2xl border border-white/10 bg-black/30 px-4 py-4 hover:bg-black/40 transition"
                                data-acc-btn>
                                ...
                                <div class="hidden mt-3 text-white/60 text-sm leading-relaxed" data-acc-panel>
                                    Após a compra, você recebe instruções e acesso no canal de suporte/Discord (ou
                                    método definido pela loja).
                                </div>
                            </button>
                            <button
                                class="w-full text-left rounded-2xl border border-white/10 bg-black/30 px-4 py-4 hover:bg-black/40 transition"
                                ...
                                <div class="hidden mt-3 text-white/60 text-sm leading-relaxed" data-acc-panel>
                                    Sim. Você pode comprar um plano diferente quando quiser, conforme disponibilidade do
                                    produto.
                                </div>
                            </button>
                            <button
                                ...
                                <div class="hidden mt-3 text-white/60 text-sm leading-relaxed" data-acc-panel>
                                    Os recursos inclusos aparecem na lista “Recursos” acima. Em caso de dúvidas, chame o
                                    suporte.
                                </div>
                            </button>
                        </div>
