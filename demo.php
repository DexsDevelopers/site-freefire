        ...
        <div class="max-w-[1600px] mx-auto px-4 sm:px-6 lg:px-8 relative">
            <div class="flex items-center justify-between h-20">
                ...
                <div class="hidden xl:flex items-center gap-6">
                    ...
                    <a href="/demo.php" class="relative text-white font-bold text-xs tracking-wider transition-colors after:content-[''] after:absolute after:-bottom-2 after:left-0 after:h-[2px] after:w-full after:bg-white after:transition-all">DEMONSTRAÇÃO</a>
            ...
            <div id="nav-mobile" class="xl:hidden hidden pb-4">
                <div class="mt-2 rounded-2xl border border-white/10 bg-black/60 backdrop-blur-md overflow-hidden">
                    <div class="grid grid-cols-2 gap-2 p-3">
                        ...
                        <a href="/demo.php" class="px-4 py-3 rounded-xl bg-white/10 hover:bg-white/10 text-white font-bold text-xs tracking-wider uppercase transition-colors">Demonstração</a>
    ...
    <main class="pt-28 pb-16">
        <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex flex-col items-center text-center">
                ...
                <p class="text-gray-400 max-w-2xl">Aqui você pode colocar vídeos, prints e tutoriais. Por enquanto, deixei um player demonstrativo.</p>
            </div>
            ...
            <div class="mt-10 grid grid-cols-1 lg:grid-cols-3 gap-6">
                <div class="lg:col-span-2 bg-white/5 border border-white/10 rounded-2xl overflow-hidden">
                    <div class="aspect-video bg-black/60 flex items-center justify-center">
                        <div class="text-center px-6">
                            <div class="mx-auto w-14 h-14 rounded-full bg-red-600/20 border border-red-600/30 flex items-center justify-center mb-4">
                                <svg xmlns="http://www.w3.org/2000/svg" class="w-7 h-7 text-red-500" viewBox="0 0 24 24" fill="currentColor"><path d="M8 5v14l11-7z"/></svg>
                            </div>
                            <div class="text-white font-black">Player de Demonstração</div>
                            <div class="text-gray-400 text-sm mt-1">Troque por um vídeo do YouTube/Drive quando quiser</div>
                        </div>
                    </div>
                    <div class="p-6">
                        ...
                        <div class="mt-2 text-gray-300 text-sm leading-relaxed">Envie seu link de vídeo que eu deixo integrado aqui com embed e layout igual ao resto do site.</div>
                    </div>
                </div>
                ...
                <div class="bg-white/5 border border-white/10 rounded-2xl p-6">
                    ...
                    <div class="mt-3 space-y-3">
                        <a href="#" class="block bg-black/50 border border-white/10 hover:border-white/20 rounded-xl p-4 transition-colors">
                        ...
                        <a href="/faq.php" class="block text-center bg-white/5 hover:bg-white/10 border border-white/10 hover:border-white/20 text-white font-bold py-3 rounded-xl transition-colors uppercase tracking-wider text-sm">
                            Abrir FAQ
                        </a>
                    </div>
                </div>
