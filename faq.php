        ...
        <div class="max-w-[1600px] mx-auto px-4 sm:px-6 lg:px-8 relative">
            <div class="flex items-center justify-between h-20">
                ...
                <div class="hidden xl:flex items-center gap-6">
                    ...
                    <a href="/faq.php" class="relative text-white font-bold text-xs tracking-wider transition-colors after:content-[''] after:absolute after:-bottom-2 after:left-0 after:h-[2px] after:w-full after:bg-white after:transition-all">FAQ</a>
            ...
            <div id="nav-mobile" class="xl:hidden hidden pb-4">
                <div class="mt-2 rounded-2xl border border-white/10 bg-black/60 backdrop-blur-md overflow-hidden">
                    <div class="grid grid-cols-2 gap-2 p-3">
                        ...
                        <a href="/faq.php" class="px-4 py-3 rounded-xl bg-white/10 hover:bg-white/10 text-white font-bold text-xs tracking-wider uppercase transition-colors">FAQ</a>
                    </div>
                    <div class="px-3 pb-3">
                        <?php if(isset($_SESSION['user_id'])): ?>
            ...
            <div class="mt-10 space-y-4">
                <details class="group bg-white/5 border border-white/10 rounded-2xl p-5 sm:p-6">
                    <summary class="flex items-center justify-between cursor-pointer list-none">
                        ...
                        <svg class="w-5 h-5 text-gray-400 transition-transform" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M6 9l6 6 6-6"/></svg>
                    </summary>
                    <div class="mt-3 text-gray-300 leading-relaxed">Escolha o jogo, selecione o plano, adicione ao carrinho e finalize. Depois, você recebe as instruções de entrega/ativação.</div>
                </details>
                ...
                <details class="group bg-white/5 border border-white/10 rounded-2xl p-5 sm:p-6">
                    ...
                    <div class="mt-3 text-gray-300 leading-relaxed">Suporte via Discord. Se você quiser, eu adiciono link direto e uma página “Suporte” também.</div>
                </details>
                ...
                <details class="group bg-white/5 border border-white/10 rounded-2xl p-5 sm:p-6">
                    ...
                    <div class="mt-3 text-gray-300 leading-relaxed">Defina sua política em <a class="text-white font-bold underline hover:text-red-500" href="/termos.php">Termos</a>. Eu consigo deixar bem claro por produto/plano.</div>
                </details>
                ...
                <details class="group bg-white/5 border border-white/10 rounded-2xl p-5 sm:p-6">
                    ...
                    <div class="mt-3 text-gray-300 leading-relaxed">Você pode consultar <a class="text-white font-bold underline hover:text-red-500" href="/status.php">Status</a> e a página de <a class="text-white font-bold underline hover:text-red-500" href="/demo.php">Demonstração</a>.</div>
                </details>
            </div>
        </div>
    </main>
