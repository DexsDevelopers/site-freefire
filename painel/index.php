...
<head>
    ...
    <link
        href="https://fonts.googleapis.com/css2?family=Inter:wght@400;500;600;700;800;900&family=Rajdhani:wght@500;600;700&display=swap"
        rel="stylesheet">
    <script>
        tailwind.config = {
            theme: {
...
<body class="bg-neutral-950 text-neutral-50 min-h-dvh font-sans antialiased">
    <div class="fixed inset-0 pointer-events-none -z-10">
        <div class="absolute inset-0 bg-[radial-gradient(1000px_700px_at_50%_0%,rgba(239,68,68,0.10),transparent_55%)]">
        </div>
    ...
    <div class="min-h-dvh flex items-center justify-center px-4 py-10">
        <div
            class="w-full max-w-6xl rounded-2xl overflow-hidden bg-black/60 border border-primary-600 shadow-[0_0_60px_rgba(239,68,68,0.15)]">
            <div class="flex flex-col md:flex-row">
                <aside
                    class="w-full md:w-80 bg-black/50 border-b md:border-b-0 md:border-r border-primary-600/40 p-6 flex flex-col">
                    <div class="flex items-center justify-between gap-4">
                        <div class="font-mono font-bold tracking-[0.2em] text-sm">
                            <span class="text-neutral-200">THUNDER</span>
                            <span class="text-primary-500 ml-2">STORE</span>
                        </div>
                        <a href="/api/auth.php?logout=true"
                            onclick="event.preventDefault(); document.getElementById('logout-form').submit();"
                            class="px-3 py-2 rounded-lg bg-white/5 border border-white/10 hover:bg-white/10 text-xs font-bold tracking-wider">
                            SAIR
                        </a>
                    ...
                    <div class="mt-8 grid grid-cols-2 md:grid-cols-1 gap-4">
                        <button type="button" data-tab="aim"
                            class="tab-btn h-14 rounded-lg font-black tracking-[0.2em] bg-white text-primary-600 shadow-[0_0_22px_rgba(255,255,255,0.35)]">
                            AIM
                        </button>
                        <button type="button" data-tab="aim2"
                            class="tab-btn h-14 rounded-lg font-black tracking-[0.2em] bg-primary-600 text-white shadow-[0_0_22px_rgba(239,68,68,0.25)] hover:bg-primary-500">
                            AIM 2
                        </button>
                        <button type="button" data-tab="visuals"
                            class="tab-btn h-14 rounded-lg font-black tracking-[0.2em] bg-primary-600 text-white shadow-[0_0_22px_rgba(239,68,68,0.25)] hover:bg-primary-500">
                            VISUALS
                        </button>
                        <button type="button" data-tab="misc"
                            class="tab-btn h-14 rounded-lg font-black tracking-[0.2em] bg-primary-600 text-white shadow-[0_0_22px_rgba(239,68,68,0.25)] hover:bg-primary-500">
                            MISC
                        </button>
                    </div>
                    ...
                    <div class="mt-10 pt-6 border-t border-white/10 flex items-center justify-between">
                        ...
                        <div
                            class="px-3 py-1 rounded-full bg-success-500/10 text-success-500 text-xs font-bold tracking-wider">
                            Online</div>
                    </div>
                </aside>
                ...
                <main class="flex-1 p-6 md:p-12">
                    <div class="flex items-center justify-center md:justify-start">
                        <div
                            class="relative inline-flex items-center justify-center px-10 md:px-16 py-4 bg-neutral-900/50 border border-neutral-800 rounded-xl">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-x-24 gap-y-10">
                            <div class="space-y-6">
                                <label class="flex items-center gap-4 cursor-pointer select-none">
                                    ...
                                    <span
                                        class="h-6 w-6 border-2 border-primary-600 peer-checked:bg-primary-600 peer-checked:shadow-[0_0_14px_rgba(239,68,68,0.45)]"></span>
